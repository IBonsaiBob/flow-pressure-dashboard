...
' 2. Archives data + metadata to the "Plot Archive" sheet.
' 3. Saves the session note to Point Index column M.
' Note: any software-plot image pasted in the PASTE AREA stays embedded in
'       the workbook. Right-click the image → "Save as Picture" if you need
'       a standalone PNG.
' ---------------------------------------------------------------------------
Sub SavePlots()
    Dim ws As Worksheet
    ...
    ' ── 2. Note about the software-plot image ─────────────────────────────
    ' Any software-plot image pasted in the PASTE AREA stays embedded in
    ' the workbook as a visual reference.  It is not exported as a separate
    ' PNG — right-click the image and use "Save as Picture" if you need a
    ' standalone file.
    saved = saved & "  Software plot: stays on sheet (right-click → Save as Picture to export)." & vbNewLine
