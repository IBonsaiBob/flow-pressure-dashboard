...
Rebuilds the Plots sheet and adds a "Plot Archive" sheet to
  Model Build Dashboard v1.42.xlsx

Run:
    python3 generate_plots.py

Outputs:
    Model Build Dashboard v1.42.xlsx   (updated in place)
...
' "Pressure Data" then "Flow Data" for a column whose name matches
...
def main() -> None:
    ...
    print("  • B4  — Enter session notes (archived to Plot Archive on Save).")
